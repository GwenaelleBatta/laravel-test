            ...
            <div class="w-full lg:w-8/12">
                ...
                <div class="mt-6">
                    <form action="/register"
                        ...
                        @csrf
                        <label for="name"
                               class="@error('name') text-red-600 @enderror block
                               mb-2">Name</label>
                        @error('name')
                        ...
                        <input id="name"
                               type="text"
                               name="name"
                               class=" @error('name')  is-invalid outline outline-red-600 outline-2 @enderror w-full rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                               value="{{old('name')}}">
